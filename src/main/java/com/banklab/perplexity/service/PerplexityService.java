...
public class PerplexityService {
    ...
    public List<String> getCompletions(List<String> descriptions) {
        ...
        String prompt =
                ...
                기타로 분류되는 경우, 웹 검색을 통해 해당 상호가 어떤 업종인지 파악한 후 분류.
                
                결과는 쉼표로 구분된 카테고리 이름 리스트로만 반환하며, 반드시 입력된 상호명 수와 동일한 개수의 카테고리만 쉼표로 구분해서 반환해.
                기타 카테고리
                ...
                기타는 최후의 수단으로만 사용하며, 유사한 카테고리가 있다면 반드시 그것을 선택할 것
