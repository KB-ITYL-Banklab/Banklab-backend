...
public interface CreditLoanOptionMapper {
     ...
     * 특정 옵션 조회
     */
    CreditLoanOption findByOptionKey(@Param("dclsMonth") String dclsMonth,
                                     @Param("finCoNo") String finCoNo,
                                     @Param("finPrdtCd") String finPrdtCd,
                                     @Param("crdtPrdtType") String crdtPrdtType,
                                     @Param("crdtLendRateType") String crdtLendRateType);

    /**
     * 옵션 업데이트
     */
    void updateCreditLoanOption(CreditLoanOption option);
