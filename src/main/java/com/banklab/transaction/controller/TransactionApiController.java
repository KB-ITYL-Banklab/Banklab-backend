...
public class TransactionApiController {
    ...
    public ResponseEntity<Map<String, Object>> getTransactionList(
        ...
        try {
            ...
            return ResponseEntity.ok(HTTPResponse.createSuccessResponse("거래 내역 저장이 완료되었습니다.", response, authInfo));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(HTTPResponse.createErrorResponse("거래 내역 저장 중 오류가 발생했습니다.", "INTERNAL_ERROR"));
        }
    }

    @PostMapping("/summary/status")
    public ResponseEntity<Map<String, Object>> checkLinkStatus(@RequestBody Map<String, String> requestBody) {
        Map<String, Object> authInfo = extractAuthInfo();
        Long memberId = (Long) authInfo.get("memberId");
    ...
    public ResponseEntity<Map<String, Object>> getSummary(
        ...
        try {
            ...
            return ResponseEntity.ok(HTTPResponse.createSuccessResponse("집계 테이블 조회에 성공했습니다.", response, authInfo));
    ...
    public ResponseEntity<Map<String, Object>> getThisByCategoryId(
        ...
        try{
            ...
            return ResponseEntity.ok(HTTPResponse.createSuccessResponse("카테고리별 거래 내역 조회에 성공했습니다.", response, authInfo));
        }catch (SecurityException e) {
            log.error("인증 오류: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(HTTPResponse.createErrorResponse(e.getMessage(), "AUTHENTICATION_ERROR"));
