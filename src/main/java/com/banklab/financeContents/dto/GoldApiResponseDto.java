...
/**
 * 공공데이터포털 금 시세 API 응답 전체 구조 DTO
 * 
 * 이 클래스는 공공데이터포털의 일반상품시세정보 API로부터 받은 JSON 응답을 
 ...
 * Jackson 라이브러리의 @JsonProperty 어노테이션을 통해 JSON 키와 매핑됩니다.
 * 
 * @author 개발팀
 * @version 1.0
 * @since 2025.01
 * @see GoldPriceInfoDto 실제 금 시세 데이터 구조
 */
@Data
public class GoldApiResponseDto {
    ...
    public static class ResponseBody {
        ...
        public static class Body {
            ...
            /** 실제 금 시세 데이터 배열을 포함하는 객체 */
            @JsonProperty("items")
            private Items items;
            
            /**
             * 금 시세 데이터 배열을 감싸는 컨테이너 클래스
            ...
            public static class Items {
                /** 금 시세 정보 객체들의 리스트 */
                @JsonProperty("item")
                private List<GoldPriceInfoDto> item;
            }
        }
    }
}