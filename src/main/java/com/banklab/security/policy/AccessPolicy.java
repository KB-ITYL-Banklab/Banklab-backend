package com.banklab.security.policy;
...
public class AccessPolicy {
    ...
    public static final List<AccessRule> PERMIT_ALL = List.of(
            ...
            new AccessRule(HttpMethod.GET, "/api/upbit/**", null),  // 금융차트 가상화페 API 공개 GET
            new AccessRule(HttpMethod.POST, "/api/upbit/**", null),  // 금융차트 가상화페 API 공개 POST
